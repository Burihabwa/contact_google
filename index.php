        ...
        <div class="col-12 col-md-5 col-lg-5 d-flex align-items-center justify-content-md-end mt-3 mt-md-0">
            <div class="mr-3 mt-1">
              ...
              <div class="dropdown">
                ...
                <img style="border-radius: 50%; width: 30px; height: 30px;" src="imag/esp.jpeg" alt="">
                    ...
                    <ul class="nav flex-column">
                        ...
                        <li class="nav-item dropdown nouveau">
                          <a class="nav-link dropdown-toggle active"  href="index.php" id="navbarDarkDropdownMenuLink" role="button" data-bs-toggle="dropdown" aria-expanded="false">
                            <img src="imag/add-user.png"  height="30px" width="30px" />
                        ...
                        <li class="nav-item frequen">
                          <a class="nav-link" href="frequent.php">
                          <img src="imag/history.png" height="30px" width="30px"/>
          ...
          <div class="">
            ...
            <div class="row g-2 ml-5 pl-5 mr-5 pr-5">
                ...
                <div class="col-md-12 pr-5">
                  ...
                  <div class="mt-2.5">
                    <input type="email" name="email" id="email" id="validationCustom04" class="email form-control" pattern="[a-z0-9._%+-]+@[a-z0-9.-]+\.[a-z]{2,4}$" required>
                  </div>
                </div>
                <div class="col-md-12 pr-5">
                <label for="validationCustom05" class="form-label">Télephone</label>
                  <div class="select-box">
                    <div class="selected-option">
                        ...
                        <input type="tel" name="tel" placeholder="Phone Number" id="validationCustom05" required>
                    </div>
                ...
                <div class="col-md-12 pr-5">
                  ...
                  <div class="mt-2.5">
                    <textarea name="message" id="decription" rows="4" class="form-control"></textarea>
                  </div>
                </div>
